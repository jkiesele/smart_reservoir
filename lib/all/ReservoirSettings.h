...
public:
    ...
    DEF_SETTING(float, circPDay,   "Circ interval [s]",  60.0f, 1.0f);
    DEF_SETTING(float, circTDay,   "Circ time day [s]",    10.0f, 1.0f);
    DEF_SETTING(float, circTNight, "Circ time night [s]",   5.0f, 1.0f);
